...
PGDUMP_STRFTIME_FMT: str = '%Y-%m-%d %H:%M:%S.%f %Z'
...
BLOB: str = 'BLOB'
BLOB_METADATA: str = 'BLOB METADATA'
BLOBS: str = 'BLOBS'
CAST: str = 'CAST'
...
PG_LARGEOBJECT_METADATA: str = 'pg_largeobject_metadata'
POLICY: str = 'POLICY'
PROCEDURE: str = 'PROCEDURE'
PROCEDURAL_LANGUAGE: str = 'PROCEDURAL LANGUAGE'
PUBLICATION: str = 'PUBLICATION'
PUBLICATION_TABLE: str = 'PUBLICATION TABLE'
PUBLICATION_TABLES_IN_SCHEMA: str = 'PUBLICATION TABLES IN SCHEMA'
ROLE: str = 'ROLE'
...
STATISTICS_DATA: str = 'STATISTICS DATA'
STDSTRINGS: str = 'STDSTRINGS'
SUBSCRIPTION: str = 'SUBSCRIPTION'
SUBSCRIPTION_TABLE: str = 'SUBSCRIPTION TABLE'
TABLE: str = 'TABLE'
TABLE_ATTACH: str = 'TABLE ATTACH'
...
SECTION_MAPPING: dict[str, str] = {
    ...
    BLOB_METADATA: SECTION_PRE_DATA,
    BLOBS: SECTION_DATA,
    ...
    PUBLICATION_TABLES_IN_SCHEMA: SECTION_POST_DATA,
    ROLE: SECTION_NONE,
